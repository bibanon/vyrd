var AdBrite_IAB_Zone_Title_Color_Default = '666666';
var AdBrite_IAB_Zone_Text_Color_Default = '940F04';
var AdBrite_IAB_Zone_Background_Color_Default = 'FFFFFF';
var AdBrite_IAB_Zone_Border_Color_Default = '000000';
var AdBrite_IAB_Zone_Title_Color_Processed,
         ...
         try {
            ...
            var AdBrite_IAB_Iframe_URL = 'http://ads.adbrite.com/adserver/display_iab_ads.php?sid=197679' +
	    ...
	    '&zs='+
            ...
            document.write('<iframe scrolling="no" frameborder="0" width=468 height=60 src=' + AdBrite_IAB_Iframe_URL + '></iframe>');img1 = new Image(); img1.src = document.location.protocol + '//ads.adbrite.com/mb/statsimg.php?nocache=' + Math.random() + '&navname=' + escape(navigator.appName) + '&navver=' + escape(navigator.appVersion) + '&sid=197679&protocol=' + self.location.protocol + '&ref=' + escape(document.referrer) + '&host=' + self.location.host + '&loc=' + escape(self.location);